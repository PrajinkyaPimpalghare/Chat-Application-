...
This Script needs to be run after ChatUser1.py
Author: Prajinkya Pimpalghare
Date: 03-December-2017
Version: 1.0
Input Variable: Server MAchine[Where ChatUser1.py is running] IP
==========================================================================================="""
import socket
...
class Server(object):
    def __init__(self):
        """
        Setting the host name and connecting to already bind connection"
        """
        self.message = ""
        self.display_file = "Chat1.txt"  # Put here Server PC IP or DN
    ...
    def sender(self, message):
        ...
        try:
            ...
            self.server_socket.send(self.message.encode())
        except BaseException as error:
            print("Error:", error)
